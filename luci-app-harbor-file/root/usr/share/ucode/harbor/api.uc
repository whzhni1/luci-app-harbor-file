...
const CONFIG          = 'harbor_file';
const CONFIG_FILE     = '/etc/config/harbor_file';
const CONFIG_SECTION  = 'main';

const ARCHIVE_STATE_FILE   = '/tmp/harbor_file_archive_state.json';
const PACKAGE_STATE_FILE   = '/tmp/harbor_file_package_install_state.json';
const THUMBNAIL_STATE_FILE = '/tmp/harbor_file_thumbnail_state.json';
...
function save_uhttpd_configuration(script_timeout, network_timeout) {
	...
	spawn_background('sleep 1; /etc/init.d/uhttpd reload', '/tmp/harbor_file_uhttpd.log');
	return null;
}
...
function save_nginx_configuration(buffering, body_size) {
	...
	spawn_background('sleep 1; /etc/init.d/nginx reload', '/tmp/harbor_file_nginx.log');
	return null;
}
...
function save_uwsgi_configuration(values) {
	...
	spawn_background('sleep 1; /etc/init.d/uwsgi reload', '/tmp/harbor_file_uwsgi.log');
	return null;
}
...
const PACKAGE_LOG   = '/tmp/harbor_file_package_install.log';
const THUMBNAIL_LOG = '/tmp/harbor_file_thumbnail.log';
const PACKAGE_RC    = '/tmp/harbor_file_package_install.rc';
const THUMBNAIL_RC  = '/tmp/harbor_file_thumbnail.rc';
...
function api_thumbnail_generate_start() {
	...
	let script = '/tmp/harbor_file_thumbnail.sh';
...
const ARCHIVE_LOG = '/tmp/harbor_file_archive.log';
const ARCHIVE_RC  = '/tmp/harbor_file_archive.rc';

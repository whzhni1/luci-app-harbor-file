/* HarborFile recovery.js - persists unsaved editor buffers and the last
 * directory so an unexpected exit can be recovered on the next visit. */
(function (HF) {
    'use strict';

    var KEY_BUF = 'harbor_file.recovery.';
    ...
    var pending = {};   // key -> value, waiting to be flushed (debounce)
    var timers = {};
